...
namespace WebApplication2.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,StudentCode,Fullname,Email,Facultyid")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,StudentCode,Fullname,Email,Facultyid")] Student student)
        {
            if (ModelState.IsValid)
            {
