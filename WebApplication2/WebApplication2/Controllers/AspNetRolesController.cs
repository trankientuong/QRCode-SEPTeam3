...
{
    //[Authorize(Roles ="Admin,Faculty,Lecturer")]
    public class AspNetRolesController : Controller
    {
        ...
        public ActionResult Search(string keyword)
        {
            ...
            var user = db.AspNetUsers.FirstOrDefault(x => x.Email.ToLower().Contains(keyword.ToLower())); //get user of keyword
            var userRole = user.AspNetRoles.Where(x => x.AspNetUsers.Any(g => g.Email.ToLower().Contains(user.Email))).ToList();
